...
class Profil extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Container(
        decoration: const BoxDecoration(color: Color.fromARGB(209, 255, 255, 255)),
        child: Column(
          children: [
            Container(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              TextStyler(
                                "Morning,",
                                color: const Color.fromARGB(143, 23, 56, 94),
                                fontSize: 15.0,
                              ),
                              const SizedBox(
                                height: 2.0,
                          ...
                          return InkWell(
                            onTap: (){
                              if (index+1==1){
                                ...
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>ProfilSimple()));
                              }else{
